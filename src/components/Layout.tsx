...
const ALL_NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { path: '/projetos/novo', label: 'Abrir TAP', icon: FolderPlus, menuKey: 'projetos/novo' },
  ...
  },
  {
    ...
    subItems: [
      ...
      { path: '/implantacao-agenda-ppe', label: 'Agenda PPE', icon: Calendar, menuKey: 'implantacao/ppe' },
  ...
  },
  {
    ...
    menuKey: 'manutencao',
    subItems: [
      { path: '/manutencao/preventivas', label: 'Agenda Preventiva', icon: Calendar, menuKey: 'manutencao/preventivas' },
  ...
  },
  {
    ...
    subItems: [
      ...
      { path: '/sucesso-cliente/chamados', label: 'Chamados', icon: MessageSquare, menuKey: 'sucesso-cliente' },
