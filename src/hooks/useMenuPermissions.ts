...
export const MENU_KEYS = [
  ...
  { key: 'implantacao/analytics', label: 'Analytics', parent: 'implantacao' },
  { key: 'implantacao/em-implantacao', label: 'PCI - Em Implantação', parent: 'implantacao' },
  { key: 'implantacao/ppe', label: 'PPE - Totens', parent: 'implantacao' },
