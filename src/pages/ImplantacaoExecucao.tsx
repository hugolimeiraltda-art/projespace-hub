  ...
  const fetchData = async () => {
    try {
      ...
      const { data: projectData, error: projectError } = await supabase
        .from('projects')
        .select('id, numero_projeto, cliente_condominio_nome, cliente_cidade, cliente_estado, vendedor_nome, created_at, prazo_entrega_projeto, implantacao_started_at, engineering_status, endereco_condominio, observacoes_gerais, observacoes')
        .eq('id', id)
        .single();
