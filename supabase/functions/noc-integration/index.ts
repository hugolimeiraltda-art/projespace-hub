      ...
      acessos_funcionais: [
        {
          label: "Formulário",
          enabled: true,
          url: `${supabaseUrl}/functions/v1/noc-project-view?project_id=${project_id}&view=form`,
        ...
        },
        {
          label: "Equipamentos",
          enabled: true,
          url: `${supabaseUrl}/functions/v1/noc-project-view?project_id=${project_id}&view=equipment`,
        ...
        },
        {
          ...
          enabled: true,
          url: `${supabaseUrl}/functions/v1/noc-project-view?project_id=${project_id}&view=details`,
